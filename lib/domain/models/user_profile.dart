...
class UserProfile {
  ...
  // Optional and unset by anything the app ships today. Used for content
  // recommendation and internal analytics only; there are no user-to-user
  // surfaces, so none of this is ever shown to anyone else (PRD 6.2).
  ...
  @override
  int get hashCode =>
      Object.hash(userId, fullName, language, msisdn, theme);
}
